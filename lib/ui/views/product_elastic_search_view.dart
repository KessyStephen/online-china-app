...
class ProductElasticSearchView extends StatefulWidget {
  @override
  _ProductSearchViewState createState() => _ProductSearchViewState();
}

class _ProductSearchViewState extends State<ProductElasticSearchView> {
                  ...
                  children: <Widget>[
                          ...
                          Expanded(
                            ...
                            child: SearchBar(
                              ...
                              onChanged: (String text) async {
                                if (text.length >= 2) {
                                  await model.suggest(text);
                                }
                              },
                              onTaped: () async {
                                if (model.elasticProducts.length > 0) {
                                  model.clearSearchData();
                                  model.toggleShowResults(false);
                                }
                              },
                            ),
                          ),
                    ...
                    model.state == ViewState.Busy
                        ...
                        : model.suggestions.length == 0 &&
                                model.elasticProducts.length == 0
                            ? Expanded(
                                flex: 1,
                                child: Center(
                                          ...
                                          children: <Widget>[
                                            ...
                                            Expanded(
                                              ...
                                              child: InfiniteGridView(
                                                ...
                                                itemBuilder: (context, index) {
                                                  ElasticProduct product = model
                                                      .elasticProducts[index];
                                                ...
                                                itemCount: model
                                                        ...
                                                        null
                                                    ? 0
                                                    : model.elasticProducts
                                                        .length, // Current itemCount you have
                                                hasNext: model.elasticProducts
                                                            .length >=
                                                        PER_PAGE_COUNT
                                                    ? this.showLoading
